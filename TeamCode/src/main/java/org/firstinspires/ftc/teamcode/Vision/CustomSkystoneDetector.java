...
public class CustomSkystoneDetector extends DogeCVDetector {
    ...
    public PerfectAreaScorer perfectAreaScorer = new PerfectAreaScorer(1421,1); // Used to find objects near a tuned area value
    ...
    public Mat process(Mat input) {
        ...
        for(MatOfPoint cont : contoursYellow){
            ...
            if(score < bestDifference && rect.y > 100){
